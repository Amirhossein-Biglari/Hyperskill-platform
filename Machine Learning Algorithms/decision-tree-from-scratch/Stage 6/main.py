...
df_train = pd.read_csv('data_stage6_train.csv', index_col='Unnamed: 0')
df_test = pd.read_csv('data_stage6_test.csv', index_col='Unnamed: 0')
...
predictions = ds.predict(df_test)

# Extract true labels from the test dataset
true_labels = df_test['Survived']

# Calculate confusion matrix to evaluate the model
confusion = confusion_matrix(true_labels, predictions)

# Calculate normalized true positive and true negative rates
...
# Print the normalized true positive and true negative rates
